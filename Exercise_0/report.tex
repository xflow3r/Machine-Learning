...
The dataset contains 363,243 instances with 67 possible features, although depending
on the individual crash report, not all features are populated. Some of the key 
features include: \textbf{1st\_Point\_of\_Impact, Weather\_Conditions, Road\_Surface\_Conditions, Light\_Conditions, Vehicle\_Type, Casualty\_Severity, Day\_of\_Week, Car\_Passenger}. These features provide a mixture of integer-encoded nominal and ordinal attributes of differing ranges, which will allow us to explore various preprocessing techniques.

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.18\textheight]{images_road_safety/Casualty_Severity_histogram.png}
        \caption{Casualty Severity Distribution}
        \label{fig:casualty_severity}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.18\textheight]{images_road_safety/1st_Point_of_Impact_histogram.png}
        \caption{Distribution of 1st Point of Impact}
        \label{fig:1st_point_of_impact}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth, height=0.18\textheight]{images_road_safety/age_band_of_driver_histogram.png}
    \caption{Distribution of Age Band of Driver}
    \label{fig:age_band_of_driver}
\end{figure}
