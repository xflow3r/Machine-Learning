...
\begin{figure}[H]
    ...
    \caption{Decision Tree Results Summary - Phishing Dataset. Performance comparison across holdout validation and GridSearchCV for 3-class phishing detection.}
...
\begin{figure}[H]
    ...
    \caption{Classification Report for Best Model - Phishing Dataset (Decision Tree). Shows performance across Legitimate, Suspicious, and Phishing classes on test set.}
...
\begin{figure}[H]
    ...
    \caption{Decision Tree Results Summary - Road Safety Dataset. Performance across different configurations for 11-class age band prediction.}
...
\begin{figure}[H]
    ...
    \caption{Classification Report for Best Model - Road Safety Dataset (Decision Tree). Per-class performance for all 11 driver age bands on test set.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{road_safety/svm/road_safety_viz_1_kernel_comparison.png}
    \caption{SVM achieves 3× improvement over random baseline on 11-class problem}
    \label{fig:road_safety_svm}
\end{figure}
